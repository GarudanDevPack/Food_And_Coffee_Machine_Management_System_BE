...
export class OrdersController {
  ...
  /** List all orders (admins see all; agents can filter by machineId) */
  @JwtAuth(RoleEnum.super_admin, RoleEnum.admin, RoleEnum.client, RoleEnum.agent)
  @Get()
  ...
  findAll(
    ...
    return this.ordersService.findAll(userId, machineId, status);
  }
  ...
  failOrder(
    ...
    return this.ordersService.failOrder(id, reason, req.user.id, req.user.role.id);
  }
